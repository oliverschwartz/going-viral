...
function init() {
  ...
  // createWall(width, new CANNON.Vec3(0, 3, -height / 2 - boxRad), true);
  // sidewalls
  createWall(height, new CANNON.Vec3(width, 3, height / 2 - boxRad));
  createWall(height, new CANNON.Vec3(0 - boxRad * 2, 3, height / 2 - boxRad));

  // endwalls
  createWall(width, new CANNON.Vec3(width / 2 - boxRad, 3, height), true);
  createWall(
    width,
    new CANNON.Vec3(width / 2 - boxRad, 3, 0 - boxRad * 2),
    true
  );
