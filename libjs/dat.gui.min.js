...
dat.GUI = dat.gui.GUI = (function(f, a, d, e, c, b, p, q, l, r, n, u, A, g, k) {
    ...
    k.extend(h, {
      options: function(b) {
        ...
        if (k.isArray(b) || k.isObject(b))
          return (
            h.remove(),
            v(a, h.object, h.property, { before: h.__li.nextElementSibling, factoryArgs: [b] })
          );
      },
      name: function(a) {
  ...
  (dat.controllers.factory = (function(f, a, d, e, c, b, p) {
    return function(q, l, r, n) {
      ...
      if (p.isNumber(u))
        return p.isNumber(r) && p.isNumber(n) ? new d(q, l, r, n) : new a(q, l, { min: r, max: n });
  ...
  (dat.controllers.ColorController = (function(f, a, d, e, c) {
    function b(a, b, d, e) {
      ...
      c.each(l, function(c) {
        a.style.cssText +=
          "background: " + c + "linear-gradient(" + b + ", " + d + " 0%, " + e + " 100%); ";
      });
    }
    function p(a) {
      a.style.background = "";
